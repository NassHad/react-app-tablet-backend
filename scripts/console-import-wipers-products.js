// Console-friendly version for Strapi console execution
...
async function importWipersProducts() {
  try {
    ...
    const brands = Object.keys(wipersData.brands).slice(0, 10); // Limit for testing
    ...
    for (const brandName of brands) {
      try {
        ...
        // Process each model for this brand (limit to first 5 models per brand)
        const modelsToProcess = brandData.slice(0, 5);
