// Test script for Lights Products import
// This script tests the import with a small sample of data
...
async function testLightsProductsImport() {
  try {
    ...
    for (const item of testData) {
      try {
        ...
        console.log(`   🏷️ Brand: ${model.brand.name} (ID: ${model.brand.id})`);
