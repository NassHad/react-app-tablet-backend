// Console-friendly version of battery models import script
...
async function importBatteryModels() {
  try {
    ...
    // Read the models.json file - using relative path from project root
    const fs = require('fs');
...
module.exports = { importBatteryModels };
