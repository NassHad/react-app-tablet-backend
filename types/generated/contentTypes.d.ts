...
export interface ApiLightDataLightData extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    EAN: Schema.Attribute.BigInteger;
    img: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    isActive: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    publishedAt: Schema.Attribute.DateTime;
    ref: Schema.Attribute.String;
    refGTI: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSpecificQuestionSpecificQuestion
  extends Struct.CollectionTypeSchema {
  collectionName: 'specific_questions';
  info: {
    displayName: 'SpecificQuestion';
    pluralName: 'specific-questions';
    singularName: 'specific-question';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    compatibility: Schema.Attribute.Relation<
      'oneToOne',
      'api::compatibility.compatibility'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::specific-question.specific-question'
    > &
      Schema.Attribute.Private;
    ...
    slug: Schema.Attribute.UID;
    type: Schema.Attribute.Enumeration<['eclairage', 'batterie']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTabletTablet extends Struct.CollectionTypeSchema {
...
export interface ApiWiperDataWiperData extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    genCode: Schema.Attribute.BigInteger;
    gtiCode: Schema.Attribute.BigInteger;
    img: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    isActive: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
